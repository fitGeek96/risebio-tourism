...
const PackageDetails = ({ title, description, price, image }) => {
  return (
    <div className="fustat-offer min-h-screen p-6 md:p-8 lg:p-12">
      <div className="max-w-3xl mx-auto bg-black bg-opacity-30 shadow-2xl rounded-lg overflow-hidden text-right transition-all duration-300 hover:shadow-3xl">
        {/* Image Section */}
        ...
        {/* Content Section */}
        <div className="p-6 md:p-8 bg-gradient-to-r from-purple-900 via-transparent to-black">
          <p
            className="text-[1.5rem] md:text-[2rem] font-semibold text-orange-500 
          ...
          {/* Payment Information */}
          <ul className="space-y-2 text-right text-gray-100 text-[1.2rem] leading-relaxed">
          ...
          <p className="text-red-500 font-bold mt-6 text-lg">
            بمجرد إرسال المبلغ، يرجى إرسال إيصال الدفع إلى البريد الإلكتروني أو
            رقم الهاتف الموجود أعلاه. سيتم تأكيد حجزكم بعد استلام الدفع.
          </p>
        </div>
        ...
        <div className="text-center mt-6 mb-4">
          <Link href="/#packages" passHref>
            <button
              className="inline-block bg-pink-500 hover:bg-yellow-600 text-white 
